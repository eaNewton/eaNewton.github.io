...
export const projects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'refactored from REST into GraphQL'
    ],
    link: 'https://app.wcrarodeo.com/',
    name: 'WCRA',
    stack: ['React', 'Node.js', 'GraphQL']
  },
  {
    ...
    name: 'BeaconLive',
    stack: ['HubSpot CMS', 'HTML + CSS'],
  },
  {
    link: 'https://app.palaterra.com/',
    name: 'Palaterra',
    stack: ['Symfony', 'PHP', 'Twig']
  },
  {
    ...
    link: 'https://bluebirdbotanicals.com/',
    name: 'Bluebird Botanicals',
    stack: ['PHP', 'Wordpress (Content Management)', 'Javascript', 'HTML + CSS']
  },
  {
